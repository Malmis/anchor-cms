...
Route::post('contact', function() {
    ...
    $me = "mail@mail.se"; // Your email address
	$footer = "-- Detta meddelande skickades från kontaktformuläret på www.gcuppsala.se. --";
    $subject = $input['contact-subject'];
    $message = $input['contact-message'];
	$message .= "\r\n\n{$footer}";

    //$header  = "From: " . $input['contact-email'] . " \r\n";
	$header  = "From: {$input['contact-name']} <{$input['contact-email']}>\r\n";
